 ...
 * Function:
 * -----------------------------------------------------------------------------------Modify--------
 * 16-12-12 上午10:57     Modified By liuhuan.
 * -----------------------------------------------------------------------------------End-----------
 */
public class AutoReplyService extends AccessibilityService {
    ...
    public void onDestroy() {
        super.onDestroy();
        Toast.makeText(this, "自动回复服务已停止", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onCreate() {
        super.onCreate();
        Toast.makeText(this, "自动回复服务已开启", Toast.LENGTH_SHORT).show();
    }
    ...
    private boolean fill() {
        ...
        if (rootNode != null) {
            return findEditText(rootNode, "上班时间机器人自动回复,如遇延迟耐心等待，或者致电13379001056");
        }
        return false;
    }
